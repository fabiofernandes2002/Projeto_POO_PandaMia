    ...
    dataBase() {
        ...
        for (const user of this.users){
            if(user.type !== "admin"){
                ...
                <td>${user.email}</td>
                <td>
                <button data-toggle="modal" data-target="#${user.username}" id="pencilButton"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil" viewBox="0 0 16 16">
