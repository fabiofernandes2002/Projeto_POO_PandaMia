    ...
    bindFormRegister() {
        this.formRegister.addEventListener("submit", event => {
            ...
            try {
                ...
                this.userController.register(this.nameSurnameRegister.value, this.usernameRegister.value, this.address.value, this.postalCode.value, this.city.value, this.birthDate.value,this.email.value, this.passwordRegister.value,this.confirmPasswordRegister);
